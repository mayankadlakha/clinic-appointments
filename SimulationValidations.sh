...
curl -i -X POST "http://localhost:3000/appointments" \
    ...
    -d '{
        "clinicianId": 0,
        "patientId": 0,
        "datetimeFrom": "2026-08-16T10:00:00.000Z",
        "datetimeTo": "2026-08-16T11:00:00.000Z"
    }'
...
curl -i -X POST "http://localhost:3000/appointments" \
    ...
    -d '{
        "clinicianId": 0,
        "patientId": 0,
        "datetimeFrom": "2026-08-16T10:59:00.000Z",
        "datetimeTo": "2026-08-16T11:30:00.000Z"
    }'
...
curl -i -X POST "http://localhost:3000/appointments" \
    ...
    -d '{
        "clinicianId": 0,
        "patientId": 0,
        "datetimeFrom": "2026-08-16T11:00:00.000Z",
        "datetimeTo": "2026-08-16T10:00:00.000Z"
    }'
...
curl -i -X POST "http://localhost:3000/appointments" \
    ...
    -d '{
        "clinicianId": 0,
        "patientId": 0,
        "datetimeFrom": "2026-08-16T09:00:00.000Z",
        "datetimeTo": "2026-08-16T09:00:00.000Z"
    }'
...
curl -i -X GET "http://localhost:3000/appointments?datetimeFrom=2026-08-16T10:30:00.000Z&datetimeTo=2026-08-16T10:30:00.000Z" \
    -H "Accept: application/json"

echo -e "\n ------------------------------------------------------------------------------ \n"
echo "Get all appointments for a non-existent clinician - expect error"
curl -i -X GET "http://localhost:3000/clinicians/90/appointments?datetimeFrom=2026-08-16T10:30:00.000Z" \
    -H "Accept: application/json"
