...
curl -i -X GET "http://localhost:3000/appointments?datetimeFrom=2026-08-16T12:00:00.000Z" \
...
curl -i -X POST "http://localhost:3000/appointments" \
    ...
    -d '{
        "clinicianId": 0,
        "patientId": 0,
        "datetimeFrom": "2026-08-16T13:00:00.000Z",
        "datetimeTo": "2026-08-16T14:00:00.000Z"
    }'
...
curl -i -X POST "http://localhost:3000/appointments" \
    ...
    -d '{
        "clinicianId": 0,
        "patientId": 0,
        "datetimeFrom": "2026-08-16T14:00:00.000Z",
        "datetimeTo": "2026-08-16T15:00:00.000Z"
    }'
